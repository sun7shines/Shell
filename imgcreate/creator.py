...
class ImageCreator(object):
    ...
    def configure(self):
        ...
        #import pdb
        #pdb.set_trace()
        arg="/usr/bin/python "+self._instroot+"/post.py "+self._instroot
        #os.system('/usr/bin/python /mnt/sysimage/post.py /mnt/sysimage')
        os.system(arg)
        rc = iutil.execWithRedirect("python",["/etc/systemupdate/database/init_db.py"], root = self._instroot,
                                stdout = "/dev/tty5",
                                stderr = "/dev/tty5")
        import pdb
        pdb.set_trace()
        # e.g tmp code for update kernel img,
        """arg="mkdir -p "+self._instroot+"/root/tmp/"
        #os.system('mkdir -p /mnt/sysimage/root/tmp/')
        os.system(arg)
        arg="scp "+self._instroot+"/boot/initramfs-2.6.32-131.21.5.el6.x86_64.img "+self._instroot+"/root/tmp/"
        #os.system('scp /mnt/sysimage/boot/initramfs-2.6.32-131.21.5.el6.x86_64.img /mnt/sysimage/root/tmp/')
        os.system(arg)
        arg=self._instroot+"/root/tmp/"
        os.chdir(arg)
        #os.chdir("/mnt/sysimage/root/tmp/")

        os.system('gzip -dc initramfs-2.6.32-131.21.5.el6.x86_64.img | cpio -id')
        arg="rm -rf "+self._instroot+"/root/tmp/initramfs-2.6.32-131.21.5.el6.x86_64.img"
        #os.system('rm -rf /mnt/sysimage/root/tmp/initramfs-2.6.32-131.21.5.el6.x86_64.img')
        os.system(arg)
        arg=self._instroot+"/version"
        #if os.access("/mnt/sysimage/version", os.F_OK):
        if os.access(arg,os.F_OK):
            arg="scp "+self._instroot+"/version "+self._instroot+"/root/tmp/etc/redhat-release"
            #os.system('scp /mnt/sysimage/version /mnt/sysimage/root/tmp/etc/redhat-release')
            os.system(arg)
            arg="scp "+self._instroot+"/etc/fronware-release "+self._instroot+"/root/tmp/etc/fronware-release"
            os.system(arg)
            #os.system('scp /mnt/sysimage/etc/fronware-release /mnt/sysimage/root/tmp/etc/fronware-release')
        else:
            arg=self._instroot+"/root/tmp/etc/redhat-release"
            #fd = file("/mnt/sysimage/root/tmp/etc/redhat-release", "w")
            fd=file(arg,"w")
            fd.write("FronOS")
            fd.close()
            arg=self._instroot+"/root/tmp/etc/fronware-release"
            #fd = file("/mnt/sysimage/root/tmp/etc/fronware-release", "w")
            fd=file(arg,"w")
            fd.write("vServer FronOS")
            fd.close()
        arg="find . | cpio -o -H newc | gzip -9 > "+self._instroot+"/root/initramfs-2.6.32-131.21.5.el6.x86_64.img"
        os.system(arg)
        #os.system('find . | cpio -o -H newc | gzip -9 > /mnt/sysimage/root/initramfs-2.6.32-131.21.5.el6.x86_64.img')
        arg="scp "+self._instroot+"/root/initramfs-2.6.32-131.21.5.el6.x86_64.img "+self._instroot+"/boot/initramfs-2.6.32-131.21.5.el6.x86_64.img"
        os.system(arg)
        #os.system('scp /mnt/sysimage/root/initramfs-2.6.32-131.21.5.el6.x86_64.img /mnt/sysimage/boot/initramfs-2.6.32-131.21.5.el6.x86_64.img')
        arg="rm -rf " + self._instroot + "/root/tmp/ "+self._instroot+"/root/initramfs-2.6.32-131.21.5.el6.x86_64.img"
        os.system(arg)
        #os.system('rm -rf /mnt/sysimage/root/tmp/ /mnt/sysimage/root/initramfs-2.6.32-131.21.5.el6.x86_64.img')"""
        #import pdb
        #pdb.set_trace()
